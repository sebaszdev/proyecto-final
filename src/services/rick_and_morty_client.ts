...
export async function getCharacterById(id: string) {
    ...
    if (!res.ok) {
        ...
        throw new Error(`Error al obtener el personaje con ID ${id}. Status: ${res.status}`);
    }
...
export async function getEpisodeById(id: string) {
    ...
    if (!res.ok) {
        throw new Error(`Error al obtener el episodio con ID ${id}. Status: ${res.status}`);
    }
...
export async function getLocationById(id: string) {
    ...
    if (!res.ok) {
        throw new Error(`Error al obtener la localización con ID ${id}. Status: ${res.status}`);
    }
